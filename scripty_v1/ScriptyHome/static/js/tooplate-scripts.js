    ...
    configLine = {
      ...
      data: {
        ...
        datasets: [
          ...
          {
            label: "Errors",
            data: [133, 545, 337, 21, 55, 474, 369, 1002],
            fill: false,
...
function drawBarChart() {
  if ($("#barChart").length) {
    ...
    configBar = {
      type: "bar",
      data: {
        labels: ["welcome", "hello", "student", "color", "master", "are","great","elephant","nueron","successful","always"],
        datasets: [
          {
            label: "No of errors",
            data: [1340,909,853,829,739,644,123,119,88,81,25],
            backgroundColor: [
              "rgba(255, 99, 132, 0.2)",
              "rgba(54, 162, 235, 0.2)",
              "rgba(255, 206, 86, 0.2)",
  ...
  if ($("#pieChart").length) {
    ...
    configPie = {
      ...
      data: {
        ...
        labels: ["Incorrect: 65.35%", "Correct: 34.65%"]
      },
      options: optionsPie
    };
